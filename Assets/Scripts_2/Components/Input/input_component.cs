...
public enum action_buttons { primary_button, secondary_button, ternary_button, scroll_up, scroll_down, jump_button, interact_button, use_button, special_button, sprint_button };
